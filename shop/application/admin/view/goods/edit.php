...
<div class="templatemo-content col-1 light-gray-bg">
    ...
    <div class="templatemo-content-container">
        ...
        <br>
        <form action="/admin/goods/{$goods['id']}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
            <input type="hidden" name="_method" value="PUT">
            <div class="form-group">
                <label for="inputID" class="col-sm-2 control-label">商品名称:</label>
                <div class="col-sm-10">
                    <input type="text" name="name" id="inputID" class="form-control" value="{$goods['name']}" title="">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select name="category_id" id="inputID" class="form-control">
                        ...
                        <?php foreach ($data as $v): ?>
                            <option value="{$v['id']}"
                                    {$goods['category_id']==$v['id']?'selected':'';}>{$v['_name']}</option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="price" id="inputID" class="form-control" value="{$goods['price']}" title=""
                    >
                </div>
            </div>
            <div class="form-group">
                <label for="inputID" class="col-sm-2 control-label">价格:</label>
                <div class="col-sm-10">
                    <input type="text" name="describe" id="inputID" class="form-control" value="{$goods['describe']}" title=""
                    >
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="input-group">
                        <input type="text" class="form-control" name="list_image" readonly=""
                               value="{$goods['list_image']}">
                        <div class="input-group-btn">
                            <button onclick="upImage(this)" class="btn btn-default" type="button">选择图片</button>
                        </div>
                    </div>
                    <div class="input-group" style="margin-top:5px;">
                        <img src="{$goods['list_image']}" class="img-responsive img-thumbnail"
                             width="150">
            ...
            <div class="form-group" id="box1">
                <label for="inputID" class="col-sm-2 control-label">详情页图册预览:</label>
                <div class="col-sm-10">
                    <?php foreach ($contentimages as $v): ?>
                        <p style="float: left;">
                                <img src="{$v}" >
                            <a href="javascript:;" onclick="remove(this)" style="display: block;color: red">X</a>
                            <input type="input" hidden name="oldimages[]" value="{$v}">
                        </p>
                    <?php endforeach; ?>
                </div>
            </div>
            <div class="form-group">
                <label for="inputID" class="col-sm-2 control-label">详情页图册修改:</label>
                <div class="col-sm-10">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea id="container" name="content"
                              style="height:300px;width:100%;">{$goods['content']}</textarea>
                    <script>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="click" id="inputID" class="form-control" value="{$goods['click']}" title=""
                    >
                </div>
            </div>
            <div class="panel panel-default col-sm-10 col-sm-offset-2" id="box">
                ...
                <div class="panel-body" v-for="(v,k) in shops">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="number" id="inputID" class="form-control" v-model="v.inventory" required="required" placeholder="默认数字">
                        </div>
                    </div>
                    <a href="" class="btn btn-danger btn-xs" @click.prevent="del(k)">删除</a>
                </div>
                <textarea name="goods" hidden cols="30" rows="10">{{shops}}</textarea>
                <a href="" class="btn btn-success btn-xs" @click.prevent="add">增加</a>
            </div>
            <div class="form-group">
