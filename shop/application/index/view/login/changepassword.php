        ...
        <div class="layout">
            ...
            <div class="n-frame device-frame reg_frame" id="main_container">
                ...
                <div class="title-item t_c">
                    <h4 class="title_big30">修改密码</h4>
                </div>
                <div class="outer-box">
                    <div class="inner-box">
                        <form id="loginForm" class="login-form" action="/index/login/changepassword" method="post">
                            原密码：
                            <label class="labelbox" for="accountInput">
                                <input type="text" class="account" id="accountInput" name="oldpassword" placeholder="原密码"/>
                            </label>
                            新密码：
                            <label class="labelbox" for="passwordInput"> <input id="passwordInput" class="password-field" type="password" placeholder="新密码" name="newpassword">
                                <input type="hidden" id="_pwdMd5" >
                            </label>
                            确认密码：
                            <label class="labelbox" for="passwordInput"> <input id="passwordInput" class="password-field" type="password" placeholder="确认密码" name="password">
                                <input type="hidden" id="_pwdMd5" >
                            </label>
...
<!--                            </label>-->
                            ...
                            <div class="auto-box">
                                ...
                                <input type="text" hidden name="username" value="<?php echo \think\Session::get('webuser.username')?>" >
                            <div class="submit-btn">
                                <input type="submit" class="btn" value="修改" id="login_web">
                            </div>
                        </form>
                        <div class="link-btn">
                            <a class="link "
...
<!--                                          src="images/tel.png"/>400-678-9688(24小时全国服务热线)</a></li>-->
<!--        </ul>-->
<!--    </div>-->
<!--    <div class="copyright">COPYRIGHT&nbsp;&copy;&nbsp;1996-2017&nbsp;&nbsp;ALL-->
