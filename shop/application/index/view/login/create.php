        ...
        <div class="layout">
            ...
            <div class="n-frame device-frame reg_frame" id="main_container">
                ...
                <div class="title-item t_c">
                    <h4 class="title_big30">帐号注册</h4>
                </div>
                <div class="outer-box">
                    <div class="inner-box">
                        <form id="loginForm" class="login-form" action="/index/login/create" method="post">
                            用户名：
                            ...
                            确认密码：
                            <label class="labelbox" for="passwordInput"> <input id="passwordInput" class="password-field" type="password" placeholder="确认密码" name="verify">
                                <input type="hidden" id="_pwdMd5" >
                            </label>
                            ...
                            <div class="submit-btn">
                                <input type="submit" class="btn" value="注册" id="login_web">
                            </div>
                        </form>
                        <div class="link-btn">
                            <a class="link "
                               href="/index/login/index">返回登陆</a>
                        </div>
                    </div>
                </div>
            </div>
