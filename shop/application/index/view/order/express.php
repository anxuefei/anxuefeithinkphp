...
{block name='header'}
<!DOCTYPE HTML>
<!--[if IE 8]><html class="lt8" lang="en-US"><![endif]-->
...
<head>
    ...
    <title>我的订单</title>
    <link href="/order/express/common-font.css" class="J_replace_public" rel="stylesheet">
    <link href="/order/express/global_8f73c7a.css" rel="stylesheet" type="text/css"/>
    <link href="/order/express/common_9277b03.css" class="J_replace_public" rel="stylesheet">
    <link href="/order/express/layout_ea3c79a.css" rel="stylesheet" type="text/css"/>
    <link href="/order/express/dialog_bc2edaf.css" rel="stylesheet" type="text/css"/>
    <link href="/order/express/home_f703714.css" type="text/css" rel="stylesheet">
    <link href="/order/express/member-center_9ab02c9.css" rel="stylesheet" type="text/css" />
    <link href="/order/express/dialog_bc2edaf.css" rel="stylesheet" type="text/css"/>
    <link href="/order/express/buy-process_ef1e513.css" rel="stylesheet" type="text/css"/>
    <link href="/order/express/member-order_edcab06.css" rel="stylesheet" type="text/css"/>
    <style>
        .a_style {
            color: #0073ea;
        }
            ...
            <dl id="member-order-list">
                ...
                <dd class="module-item">
                    <ul class="statistic-tags cl">
                        <li ><a href="/index/order/lists">全部</a></li>
                        <li><a
                                ...
                                <tr class="order-line">
                                    ...
                                    <td colspan="4">
                                        ...
                                        <table class="order-sub-table">
                                            ...
                                            <tr class="prod-line">
                                                <td class="prod-pic">
                                                    <a class="figure" href="/index/index/content?id={$cart['id']}"><img
                                                                src="{$cart['img']}" alt=""/></a>
                                                </td>
                                                <td colspan="3">
                                    ...
                                    <td class="operation">
                                        <ul>
                                            <?php if ($order['is_over'] == 0) { ?>
                                                <li>  <a href="javascript:expressupdate({$order['id']});" >确认收货</a></li>
                                            <?php } else { ?>
                                            <li> 已收货
                                                <?php }; ?>
                    ...
                    <div class="no-record no-order"><img src="https://swsdl.vivo.com.cn/vivoshop/web/dist/img/member/no-order-icon_3030d23.png"/><span>您还没有订单</span>
                    </div>
...
<script>
    function expressupdate(id) {
        alert(1);
        $.ajax({
            url:'/index/order/expressupdate',
            type:'post',
            data: {orderid:id},
...
<script src="/order/express/jquery.min_f03e5a3.js"></script>
<script src="/order/express/TweenMax.min_92cf05a.js"></script>
<script src="/order/express/header_7e581c3.js"></script>
